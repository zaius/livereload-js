...
var PROTOCOL_7, Parser, ProtocolError,
  ...
  Parser.prototype.process = function(data) {
    ...
    try {
      if (this.protocol == null) {
        if (message = this._parseMessage(data, ['hello'])) {
...
// connector
// Generated by CoffeeScript 1.7.1
var Connector, PROTOCOL_7, Parser, Version, _ref;

_ref = __protocol, Parser = _ref.Parser, PROTOCOL_7 = _ref.PROTOCOL_7;
...
extend = function() {
  var key, source, sources, target, value, _i, _len;
  target = {};
...
Options.defaults = {
  ...
  uri: function() {
    ...
    return "" + proto + "//" + this.host + ":" + this.port + "/livereload";
  }
};

Options.extract = function() {
  var env, key, options, value;
  ...
  for (key in options) {
    ...
    if (typeof value === 'function') {
      options[key] = value.apply(options);
    }
  }
  return options;
};
